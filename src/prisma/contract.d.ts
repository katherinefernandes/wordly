...
export type StorageHash =
  StorageHashBase<'b611298c86bcfae237c3cffda02eaf87c6fd67b7036cc248a00c1e29ad711d73'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly Word: {
      ...
      readonly frequencyRank: CodecTypes['pg/int4@1']['output'];
    };
  };
};
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly Word: {
      ...
      readonly frequencyRank: CodecTypes['pg/int4@1']['input'];
    };
  };
};
...
export namespace Models {
  export type public_Word = {
    ...
    word: CodecTypes['pg/text@1']['output'];
    translation: CodecTypes['pg/text@1']['output'];
    frequencyRank: CodecTypes['pg/int4@1']['output'];
    classification: public_Classification | null;
    readonly [RelationKeys]?: 'classification';
  };
  export type public_Classification = {
    id: CodecTypes['pg/int4@1']['output'];
    status: CodecTypes['pg/text@1']['output'];
    wordId: CodecTypes['pg/int4@1']['output'];
    word: public_Word;
    readonly [RelationKeys]?: 'word';
  };
}
...
export declare const models: {
  public: {
    ...
    Classification: Models.public_Classification;
  };
};
        ...
        readonly entries: {
          readonly table: {
            readonly classification: {
              ...
              uniques: readonly [{ readonly columns: readonly ['wordId'] }];
              indexes: readonly [];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'classification';
            ...
            readonly word: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [
                { readonly columns: readonly ['word'] },
                { readonly columns: readonly ['frequencyRank'] },
              ];
              indexes: readonly [];
              foreignKeys: readonly [];
            };
          ...
          readonly Word: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly frequencyRank: { readonly column: 'frequencyRank' };
              };
            };
          };
        };
